...
app.layout = [
    ...
    html.Hr(),
    html.Div(children='primeiro radio item'),
    dcc.RadioItems(options=['pop', 'lifeExp', 'gdpPercap'], value='lifeExp', id='controls-and-radio-item'),
    html.Hr(),
    html.Div(children='segundo radio item'),
    dcc.RadioItems(options=['pop', 'lifeExp', 'gdpPercap'], value='lifeExp', id='controls-and-radio-item2'),
